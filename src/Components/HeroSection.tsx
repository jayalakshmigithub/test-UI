...
>
  ...
  >
    ...
    {!isNarrowDesktop && (
      <Box sx={{ mt: 2, zIndex: 5, position: 'relative' }}>
        <Button
          variant="contained"
          sx={{
  ...
  <Box
    sx={{
      ...
      top: isTabletOrSmaller ? '15%' : '-80px',
      left: isTabletOrSmaller ? 0 : 'auto',
      display: 'flex',
      justifyContent: 'center',
      alignItems: 'flex-start',
      zIndex: isNarrowDesktop ? 3 : 1,
      pointerEvents: 'none',
    }}
  >
    <Box
      ...
      sx={{
        ...
        filter: isNarrowDesktop ? 'brightness(1.5) blur(1px)' : 'none',
        zIndex: 3,
        opacity: 0.75,
      }}
    />
